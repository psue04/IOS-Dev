...
extension Forecast {
    ...
    static let daily: [Forecast] = [
        ...
        Forecast(date: .init(timeIntervalSinceNow: day * 2), weather: .windy, probability: 0, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
        Forecast(date: .init(timeIntervalSinceNow: day * 3), weather: .rainy, probability: 0, temperature: 18, high: 24, low: 18, location: "Montreal, Canada"),
    ...
    static let cities: [Forecast] = [
        ...
        Forecast(date: .now, weather:.tornado, probability: 0, temperature: 23, high: 26, low: 16, location: "Tenessee, United States")
    ]
}
